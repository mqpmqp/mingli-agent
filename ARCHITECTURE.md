...
Phase-specific APIs remain available. The P23 V2 contract intentionally rejects legacy `baseline_domains`, because accepting caller-created domain conclusions bypasses P7–P16. Consumers should pass birth data, anchor year, reality facts, and auditable evidence instead.
